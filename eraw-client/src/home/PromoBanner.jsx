    ...
    <div className='mt-16 py-12 bg-salmon px-4 lg:px-24'>
        <div className='flex flex-col md:flex-row justify-between items-center gap-12'>
            <div className='md:w-1/2'>
                ...
                <Link to="/shop" className='block'><button className='bg-orange3 text-white font-semibold px-5 py-2 rounded hover:bg-darkoran transition-all dutation-300 mb-5'>Get Promo Code</button></Link>
            </div>
            <div>
