                ...
                <div className="max-w-md mx-auto">
                    ...
                    <div className="divide-y divide-gray-200">
                        <form onSubmit={handleSignUp} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <p>If you have an account, please <Link to="/login" className='text-orange3 hover:text-blue-700 underline'>
                            Login</Link></p>
                            <div className="relative">
                                <button className="bg-orange3 hover:bg-blue2 text-white rounded-md px-6 py-2">Sign up</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div className='flex w-full items-center flex-col mt-5 gap-3 hover:text-blue-700'>
                        <button onClick={handleRegister} className='block'><img 
